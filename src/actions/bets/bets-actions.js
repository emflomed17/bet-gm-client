...
import type { BetsActionType } from "./bets-types";
import type { Dispatch, ThunkAction } from "../action_types";
import { getBets } from "../../api/bets";

export const getGroupBets = (): ThunkAction<BetsActionType, string> => {
  return async (dispatch: Dispatch<BetsActionType, string>) => {
    dispatch({
